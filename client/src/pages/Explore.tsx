...
// Mock creator posts data
const MOCK_CREATOR_POSTS = [
  {
    id: 'post1',
    creator: {
      id: '1',
    ...
    thumbnail: 'https://images.unsplash.com/photo-1682687220645-a27985362b31?w=400&h=300&fit=crop',
    title: 'New character design inspired by nature',
    likes: 125,
    comments: 32,
    timeAgo: '2 hours ago',
    tier: 'Fan',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1583454110551-21f2fa28d105?w=400&h=300&fit=crop',
    title: 'Quick full body workout routine',
    likes: 380,
    comments: 85,
    timeAgo: '5 hours ago',
    tier: 'Basic',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1511376772211-7c44c6a236fe?w=400&h=300&fit=crop',
    title: 'Creating a melody with a simple synth',
    likes: 95,
    comments: 22,
    timeAgo: '1 day ago',
    tier: 'Producer',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1519389950473-47a04a245839?w=400&h=300&fit=crop',
    title: 'Best new gadgets of the month',
    likes: 420,
    comments: 98,
    timeAgo: '1 day ago',
    tier: 'Follower',
  ...
  return (
    <EdgeToEdgeContainer>
      ...
      <EdgeToEdgeContainer maxWidth="7xl" enablePadding className="py-6 sm:py-8">
        ...
        {/* Creator Posts - Instagram Style Feed */}
            <div className="space-y-0 -mx-4">
              {MOCK_CREATOR_POSTS.map((post) => (
