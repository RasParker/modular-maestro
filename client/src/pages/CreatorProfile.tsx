...
const MOCK_CREATORS = {
  ...
  'original badman': {
    ...
    avatar: localStorage.getItem('profilePhotoUrl') || 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
    cover: localStorage.getItem('coverPhotoUrl') || 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=800&h=300&fit=crop',
