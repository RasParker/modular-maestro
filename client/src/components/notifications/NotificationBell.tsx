...
export const NotificationBell: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <Card className="absolute right-0 top-12 w-96 max-w-[calc(100vw-1rem)] max-h-96 shadow-lg border z-50 bg-background md:transform-none transform -translate-x-[calc(100%-2.5rem)]">
